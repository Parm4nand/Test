  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="bg-white border border-gray-200 rounded-sm px-10 py-10 flex flex-col items-center gap-4">
        {/* Logo */}
        <h1 className="text-4xl font-bold tracking-tighter text-gray-900 mb-2" style={{ fontFamily: 'Billabong, cursive' }}>
          Instaclone
        </h1>
        ...
        <div className="flex flex-col gap-2 w-full">
          <button
            ...
            className="flex items-center justify-center gap-2 w-full rounded-lg border border-gray-300 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-50"
          >
        ...
        <Link href="/login" className="text-xs text-blue-900 font-semibold hover:underline mt-1">
          Forgot password?
        </Link>
      </div>
